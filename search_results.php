<?php
	...
	// STEP 2
	$sql = "SELECT dvd_titles.title, dvd_titles.release_date, genres.genre, ratings.rating, dvd_titles.dvd_title_id
	FROM dvd_titles
	JOIN genres
			...
			<div class="col-12">
				<table class="table table-hover table-responsive mt-4">
					...
					<?php while($row = $results->fetch_assoc()):?>
						<tr>
							<td>
								<a onclick="return confirm('Are you sure you want to delete this DVD?');" href="delete.php?dvd_title_id=<?php echo $row['dvd_title_id'] ?> & title=<?php echo $row['title'] ?>" class="btn btn-outline-danger"> Delete
								</a>
							</td>
							<td>
